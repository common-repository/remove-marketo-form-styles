...
if ( !class_exists( 'RemoveMarketoStyles' ) ) {
    ...
    class RemoveMarketoStyles
    {
		...
		public function __construct() {
			$this->remove_mkto_styles_js_file = plugins_url( '/js/remove-mkto-styles.js', __FILE__ );
        }
		
		public function remove_mkto_styles_enque_js() {
			wp_enqueue_script( 'remove_mkto_styles', $this->remove_mkto_styles_js_file, array('jquery'), '1.0.0', true );
        }
